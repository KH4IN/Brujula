...
- La PWA no precargaba el nuevo archivo del tema para el primer uso sin conexión. [PR #21](https://github.com/KH4IN/Brujula/pull/21) lo añadió a la caché de `staging` y [PR #22](https://github.com/KH4IN/Brujula/pull/22) propone el mismo ajuste a `main`; build y simulación del evento install correctos.
...
| --- | --- | --- | --- |
| 2026-09-25 | Retorno de Auth de pruebas guardado por el fundador; caché PWA revisada | Login/sync aún sin prueba real; PR #21 en staging, #22 pendiente de producción | [PR #21](https://github.com/KH4IN/Brujula/pull/21) |
