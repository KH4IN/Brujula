...
- [PR #46](https://github.com/KH4IN/Brujula/pull/46) en pruebas y [PR #47](https://github.com/KH4IN/Brujula/pull/47) en producción: envío pendiente con puntos de control cada 25 confirmaciones. En Node con 1.000 movimientos sintéticos y emisor sin red, el mantenimiento local pasó de 3.987 ms y 1.000 escrituras a 278 ms y 40 escrituras; con 5.000 fueron 5.705 ms y 200 escrituras tras el cambio. 39 pruebas y build; ambos despliegues READY. Una petición remota por movimiento y descarga completa de tablas siguen pendientes de medir y optimizar con el backend de pruebas. La recuperación tras interrupción puede reenviar hasta 24 operaciones idempotentes.
- [PR #49](https://github.com/KH4IN/Brujula/pull/49) en pruebas y [PR #50](https://github.com/KH4IN/Brujula/pull/50) en producción: upserts de movimientos en grupos de hasta 25. La prueba simulada de 500 movimientos genera 20 peticiones en lugar de 500, salvo conflictos que activan reintento individual. 42 pruebas, build y ambos despliegues READY. Se confirmó con dos filas ficticias en una transacción revertida que el esquema de pruebas acepta el lote bajo RLS. Faltan tiempos reales de red, carga inicial en móvil y sincronización entre dos dispositivos; la descarga completa de cinco tablas continúa.
