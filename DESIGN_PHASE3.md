...
- Revisar con el fundador en `staging` antes de llevar el cambio a producción. En iPhone comprobar ancho, foco, desplazamiento tras pulsar, tema oscuro/claro y salto de un día/categoría a Movimientos.
