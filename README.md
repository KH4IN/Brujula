...
5. Ejecutar `npm run build` y publicar el repositorio en Vercel con el framework Vite. Añadir las mismas dos variables a la configuración del proyecto de Vercel, para Production y Preview, y volver a desplegar. Después de verificar el despliegue, completar el paso 3.
