...
export default function App(){
  ...
  const filtered=monthly.filter(x=>(filter==='all'||x.kind===filter)&&`${x.description} ${x.category} ${x.occurred_on}`.toLocaleLowerCase('es').includes(search.toLocaleLowerCase('es'))).sort((a,b)=>b.occurred_on.localeCompare(a.occurred_on));
